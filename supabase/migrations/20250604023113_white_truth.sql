/*
  ...
  1. New Tables
    - `products`
      ...
      - Tracks ingredients with quantities and costs
    - `recipes`
      - Recipe definitions
      - Tracks yield and creation dates
    - `recipe_ingredients`
      - Junction table for recipe-product relationships
      - Tracks quantities used in recipes
    - `geladinhos`
      - Final product information
      - Links to recipes and includes pricing details
  ...
  3. Enums
    - `unit_measure`: Units of measurement for products
